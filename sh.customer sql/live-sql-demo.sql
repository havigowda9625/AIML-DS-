...
-- SELECT CUST_GENDER='M' from SH.CUSTOMERS
-- where CUST_GENDER='M'

-- 3. Retrieve all female customers (`CUST_GENDER = 'F'`) living in Sydney.
-- SELECT CUST_GENDER='F' || CUST_CITY from SH.CUSTOMERS
-- where CUST_GENDER='F'
...
-- SELECT COUNTRY_ID FROM SH.CUSTOMERS
