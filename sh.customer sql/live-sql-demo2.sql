...
-- SELECT CUST_CITY ,COUNT(CUST_ID) FROM SH.CUSTOMERS
-- GROUP BY CUST_CITY
...
-- SELECT CUST_MARITAL_STATUS,COUNT(CUST_MARITAL_STATUS) FROM SH.CUSTOMERS
...
-- SELECT CUST_GENDER , AVG(CUST_YAER_OF_BIRTH) FROM SH.CUSTOMERS
-- GROUP BY CUST_GENDER

-- 35. Find genders with average year of birth after 1990.
-- SELECT CUST_YEAR_OF_BIRTH,count(*) from sh.CUSTOMERS 
-- group by CUST_YEAR_OF_BIRTH
-- HAVING COUNT(*)>1990

-- 36. Count the number of customers in each country.
-- SELECT  COUNTRY_ID ,COUNT(CUST_ID) FROM SH.CUSTOMERS
-- GROUP BY COUNTRY_ID
...
-- SELECT CUST_CREDIT_LIMIT,COUNT(CUST_STATE_PROVINCE) FROM SH.CUSTOMERS
